    ...
    return (
        <div class={styles.buttonContainer}>
            ...
            <div class={styles.defaultButton}>
                <svg class={styles.buttonImg} xmlns="http://www.w3.org/2000/svg" width={(width + 1) * 5} viewBox="0 -0.5 28 15" shape-rendering="auto">
            ...
            <div class={styles.hide}>
                <svg xmlns="http://www.w3.org/2000/svg" width={(width + 1) * 5} viewBox="0 -0.5 28 15" shape-rendering="crispEdges">
                    <metadata>Made with Pixels to Svg https://codepen.io/shshaw/pen/XbxvNj</metadata>

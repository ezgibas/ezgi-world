...
export default function PinkButton(props) {
    ...
    const x = (width - (text.length * fontSize * 0.5)) / 2;
    const xStr = x.toString();
    const yStr = y.toString();
    return (
        <div class={styles.buttonContainer}>
            <div class={styles.defaultButton}>
                <svg class={styles.buttonImg} xmlns="http://www.w3.org/2000/svg" width={(width + 1) * 3} viewBox="0 -0.5 28 15" shape-rendering="auto">
            ...
            <div class={styles.hide}>
                <a class={styles.buttonLink} href={props.href}>
                    <svg xmlns="http://www.w3.org/2000/svg" width={(width + 1) * 3} viewBox="0 -0.5 28 15" shape-rendering="crispEdges">
                        <metadata>Made with Pixels to Svg https://codepen.io/shshaw/pen/XbxvNj</metadata>
